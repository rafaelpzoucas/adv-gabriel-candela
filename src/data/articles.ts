import againstWoman from '../../public/articles/against-woman.jpg'
import cannabis from '../../public/articles/cannabis.jpg'
import freedom from '../../public/articles/freedom.jpg'
import sexualCrime from '../../public/articles/sexual-crime.jpg'
import stalking from '../../public/articles/stalking.jpg'
import topless from '../../public/articles/topless.jpg'
  ...
  data: [
    {
      ...
      cover_img: stalking,
      title: 'Stalking',
      subtitle: 'A Perseguição Incessante e os Desafios Legais',
      summary:
      ...
      body: `O crime de perseguição, conhecido como stalking, foi introduzido no Código Penal pela Lei nº 14.132/2021 [1], a qual inseriu o art. 147-A, que tipifica o crime de perseguição (stalking), assim como revogou expressamente o art. 65 da Lei de Contravenções Penais, que previa a infração penal de perturbação da tranquilidade [2], representando um marco importante na legislação brasileira ao reconhecer e penalizar condutas que ameaçam não apenas a integridade física, mas também a integridade psicológica e emocional das vítimas.
     ...
     `,
      references: [
        ...
        'https://www.tjdft.jus.br/consultas/jurisprudencia/jurisprudencia-em-temas/jurisprudencia-em-perguntas/direito-penal-e-processual-penal/crime-de-perseguicao-stalking/o-crime-de-perseguicao-exige-a-reiteracao-da-conduta-delituosa',
        'https://www.conjur.com.br/2021-abr-06/academia-policia-stalking-crime-perseguicao-ameacadora/',
        'https://www.tjdft.jus.br/institucional/imprensa/campanhas-e-produtos/direito-facil/edicao-semanal/stalking-1',
        'https://www.migalhas.com.br/depeso/369794/o-crime-de-stalking-previsto-no-art-147-a-do-cp',
      ],
    },
    {
      id: 2,
      cover_img: sexualCrime,
      title: 'Importunação Sexual',
      subtitle: 'Reflexos da Lei 13.718/18 no ordenamento jurídico',
      summary:
      ...
      body: `A Lei nº 13.718, em vigor desde 24 de setembro de 2018, trouxe importantes alterações ao Código Penal Brasileiro, ao introduzir o crime de importunação sexual. Este novo dispositivo legal, contemplado no artigo 215-A, foi incluído no capítulo dos "Crimes Contra a Liberdade Sexual".
      ...
      `,
      references: [
        'https://www.tjdft.jus.br/institucional/imprensa/campanhas-e-produtos/direito-facil/edicao-semanal/importunacao-sexual',
        'https://www.tjpr.jus.br/web/cevid/noticias/-/asset_publisher/b0bN0gNEc6Uo/content/o-que-e-crime-de-importunacao-sexual-',
        'https://www.planalto.gov.br/ccivil_03/decreto-lei/del2848compilado.htm',
        'https://www.conjur.com.br/2018-set-30/cezar-bitencourt-anatomia-crime-importunacao-sexual/',
    ...
    },
    {
      ...
      body: `O debate em torno das saídas temporárias de presidiários em datas comemorativas reflete a complexidade do sistema carcerário e os desafios enfrentados na busca por uma ressocialização efetiva dos detentos. Ao analisar os argumentos apresentados, é possível perceber que as saídas temporárias desempenham um papel crucial na reintegração dos presos à sociedade, ao mesmo tempo em que levantam preocupações sobre a segurança pública.

      Por um lado, os defensores das saídas temporárias destacam sua contribuição para a redução da reincidência criminal, a humanização do sistema prisional e a reintegração gradual dos detentos à comunidade, pois o contato com familiares e a participação em atividades sociais durante esses períodos são fundamentais para promover uma transição bem-sucedida para a vida em liberdade [1].
      
      Por outro lado, os críticos das saídas temporárias alertam para os riscos que essas medidas podem representar para a segurança pública. Casos de presos que aproveitam esses períodos para cometer novos crimes, destacam a necessidade de um cuidadoso monitoramento, avaliação dos beneficiários dessas saídas e até extinção do benefício, mesmo com a existência de dados concretos demonstrando o ínfimo aumento de criminalidade ou de taxa de fuga no período [2].
      
      A saída temporária é um benefício concedido a presos do regime semiaberto, regulamentado pela Lei de Execução Penal (Lei nº 7.210/1984). Para obtê-la, o preso deve ter cumprido parte da pena e apresentar bom comportamento carcerário, conforme os critérios estabelecidos no artigo 123 da referida lei [3]. O direito ao benefício será disponibilizado por prazo não superior a 7 (sete) dias, podendo ser renovado por mais 4 (quatro) vezes durante o ano. conforme o artigo 124.
      
      As saídas temporárias podem ser concedidas para visita à família em datas específicas, para estudo, desde que o curso seja realizado na mesma comarca do cumprimento da pena e participação em atividades que concorram para o retorno ao convívio social. A autorização será concedida por ato motivado do Juiz da execução, ouvidos o Ministério Público e a administração penitenciária, conforme os artigos 122 e 123.
      
      Faltas disciplinares podem prejudicar a concessão da saída temporária, com consequências que variam de acordo com a gravidade da falta, e o preso que praticou conduta leve ou média, poderá ser reabilitado para o benefício em 30 ou 60 dias, conforme o Regimento Interno do Presídio. Durante a saída temporária, o preso deve manter comportamento adequado, evitando atividades que possam configurar falta grave, crime doloso, desatender condições impostas ou revelar baixo grau de aproveitamento do curso, implicando em revogação do benefício, conforme o artigo 125 da LEP.
      
      Atrasos no retorno da saída devem ser justificados e documentados, diretamente a direção do presídio, caso ocorram por motivo de doença ou outro impedimento. 
      
      Em resumo, a saída temporária é um instrumento para promover a ressocialização do preso, desde que observadas as regras e condições previstas na legislação penal [4]. Diante desse cenário, é essencial buscar um equilíbrio entre a promoção da ressocialização dos presos e a garantia da segurança da sociedade. Isso requer a implementação de políticas e programas que ofereçam suporte adequado aos detentos durante e após as saídas temporárias, além de medidas eficazes de monitoramento e controle.
      
      É responsabilidade do Estado organizar e investir em políticas de ressocialização, garantindo pessoal capacitado e estrutura adequada para acompanhar e apoiar os reeducandos. Somente assim essas medidas poderão apresentar resultados positivos tanto para os indivíduos quanto para a segurança pública, contribuindo para uma reintegração bem-sucedida na vida em sociedade [5].
      
      No momento de publicação deste artigo, segue para apreciação presidencial o projeto de lei 2.253/2022, o qual prevê o fim das saídas temporárias em casos de visitas à família e atividades de retorno ao convívio social, além da realização de exame criminológico para progressão de regime, em uma manobra populista e sem embasamento em dados, visto que os existentes, atestam  a inexistência ou se não, insignificante aumento de criminalidade ou fuga durante o benefício, como demonstrado anteriormente. Punir por punir, se mostrou ao longo da história, ineficaz e hoje retornamos a tempos sombrios.
      
      Em última análise, o futuro das saídas temporárias de presidiários em datas comemorativas dependerá de uma abordagem empírica e baseada em evidências, que leve em consideração os diversos interesses em jogo e busque soluções que contribuam para um sistema de justiça criminal mais justo, humano e seguro. 
      `,
      references: [
        'https://www.tjpi.jus.br/portaltjpi/tjpi/noticias-tjpi/vep-divulga-dados-relativos-a-criminalidade-durante-saidas-temporarias/',
        'https://redejusticacriminal.org/4-motivos-para-voce-ser-a-favor-das-saidas-temporarias/',
        'https://www.planalto.gov.br/ccivil_03/leis/l7210.htm',
        'https://www.pge.sp.gov.br/centrodeestudos/bibliotecavirtual/presos/parte9.htm',
        'https://www.defensoriapublica.pr.def.br/Noticia/Quais-sao-regras-para-saidas-temporarias-de-pessoas-privadas-de-liberdade',
      ],
    },
    {
      id: 4,
      cover_img: topless,
      title: 'Ato Obsceno',
      subtitle: 'Definição e Implicações Jurídicas',
      summary:
      ...
      body: `O ato obsceno é um crime previsto no artigo 233 do Código Penal Brasileiro. Segundo a legislação, configura-se como a prática de obscenidade em lugar público, aberto ou exposto ao público. A pena correspondente varia de detenção de três meses a um ano, ou multa.
      ...
      references: [
        ...
        'https://josenabucofilho.com.br/ato-obsceno-art-233/',
        'https://meusitejuridico.editorajuspodivm.com.br/2018/04/20/stf-julgara-constitucionalidade-crime-de-ato-obsceno/',
      ],
    },
    {
      id: 5,
      ...
      subtitle: 'Uma Análise Profunda dos Aspectos Jurídicos e Sociais',
      summary:
      ...
      body: `O tráfico de drogas é um fenômeno de grande complexidade, tanto do ponto de vista jurídico quanto social. No Brasil, a Lei de Drogas (Lei nº 11.343/06) define de forma clara as condutas consideradas como tráfico, abrangendo desde a importação e exportação até a produção, venda e distribuição de substâncias ilícitas. De acordo com o artigo 33 da referida lei, o indivíduo que importar, exportar, remeter, preparar, produzir, fabricar, adquirir, vender, expor à venda, oferecer, ter em depósito, transportar, trazer consigo, guardar, prescrever, ministrar, entregar a consumo ou fornecer drogas, ainda que gratuitamente, sem autorização ou em desacordo com determinação legal ou regulamentar, está sujeito à pena de reclusão de 5 a 15 anos e pagamento de multa [1].
      ...
      references: [
        ...
        'https://www.scielo.br/j/urbe/a/R7hbSpymXbtQPy5L3yN66Ft/?lang=pt',
        'https://www.institutopsicologico.org/blog/internacao/quais-os-fatores-de-risco-para-dependencia-quimica',
        'https://www.dio.me/articles/utilizando-o-iot-no-combate-ao-trafico-de-drogas-tecnologia-e-estrategias-eficientes',
      ],
    },
    {
      id: 6,
      cover_img: againstWoman,
      title: 'Violência Doméstica no Brasil',
      subtitle:
        'O Impacto das Medidas Protetivas e os Desafios para sua Implementação',
      summary:
      ...
      body: `Apesar do incremento das políticas públicas destinadas ao combate da violência doméstica, esses crimes ainda ostentam um índice significativo de ocorrências registradas, tendo como característica prevalente nessa prática delituosa, a escassez de testemunhas capazes de atestarem a violência perpetrada, dada a sua consumação majoritariamente no interior das residências das partes envolvidas.
      ...
      references: [
        ...
        'https://www.tjmt.jus.br/noticias/74402',
        'https://forumseguranca.org.br/wp-content/uploads/2023/08/anuario-2023-texto-07-o-crescimento-de-todas-as-formas-de-violencia-contra-a-mulher-em-2022.pdf',
